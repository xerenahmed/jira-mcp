...
use super::models::{
    AddLabelInput, GetFieldDetailsInput, GetIssueInput, ListBoardsInput, ListFieldsInput,
    ListIssueTypesInput, ListProjectsInput, SearchIssuesInput, SearchUsersInput,
};
...
impl ServerHandler for JiraAssistantServer {
    fn get_info(&self) -> ServerInfo {
        ServerInfo {
            ...
            instructions: Some("Jira Assistant tools: create_issue, update_issue, search_issues, list_fields, get_field_details, list_issue_types, list_boards, get_issue, get_user_info, list_projects, search_users, add_label".into()),
        }
    }
}
